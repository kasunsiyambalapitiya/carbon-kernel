...
public class ServerConfiguration implements ServerConfigurationService {
     ...
     * @throws org.wso2.carbon.base.ServerConfigurationException if the operation failed.
     */
    ...
    public void setConfigurationProperty(String key, String value) {
        ...
        while (tokenizer.hasMoreTokens()) {
            ...
            if (ele != null) {
                ele = ele.getFirstChildWithName(new QName(CarbonBaseConstants.NAMESPACE_OF_THE_SERVER_NODE_OF_CARBON_XML, token, ""));
            } else {
                break;
            }
        }
